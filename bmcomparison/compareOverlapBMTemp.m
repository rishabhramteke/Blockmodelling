function [dist] = compareOverlapBMTemp(sPosFile1, sGraphFile1, sPosFile2, sGraphFile2,...
    bHeader1, bHeader2, bListFormat, vNum1, vNum2, bMatlabFormat, bSparse, bAddOneToIndex, sReconDist, sPosDist, sCombDist, sOutFile, combParam)
%
...
% load positions
[mVertPosMap1, aPartInfo1] = loadPositionsTemp(sPosFile1, bHeader1, bListFormat, vNum1);
[mVertPosMap2, aPartInfo2] = loadPositionsTemp(sPosFile2, bHeader2, bListFormat, vNum2);
