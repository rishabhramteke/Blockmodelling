function genWeightedBlockmodelScript(sFileoutPrefix, numGraphPerTest, vGraphSize, vPosNum,...
    sPosDist, sBlockmodelType, vMeanDense, vStdDense, ccDenseBlockParams, meanSparse, stdSparse, cSparseBlockParams,...
        vBackgroundProp, bShuffle, bFileOutput, varargin)
%
    ...
    for g = 1 : length(vGraphSize)
        ...
        for i = 1 : numGraphPerTest
            ...
            for posNum = vPosNumStart : vPosNumEnd
                ...
                % weighted graph
                genWeighted(sFileoutPrefix, sPosDist, sBlockmodelType,...
                    vMeanDense, vStdDense, ccDenseBlockParams, meanSparse, stdSparse, cSparseBlockParams,...
                        vBackgroundProp, bShuffle, bFileOutput, i, graphSize, posNum, varargin{:})
                end
...
function genWeighted(sFileoutPrefix, sPosDist, sBlockmodelType,...
            vMeanDense, vStdDense, ccDenseBlockParams, meanSparse, stdSparse, cSparseBlockParams,...
                vBackgroundProp, bShuffle, bFileOutput, graphIndex, graphSize, posNum, varargin)
    %
    ...
    if length(varargin) > 0
        [~, ~, cmImageGraph, cmShuffledAdjMat, vShuffledVertPos] =...
            genWeightedBlockmodelWithBackground(sPosDist, posNum, graphSize, bShuffle, vBackgroundProp, sBlockmodelType,...
                vMeanDense, vStdDense, ccDenseBlockParams, meanSparse, stdSparse, cSparseBlockParams, varargin{1});
    else
        [~, ~, cmImageGraph, cmShuffledAdjMat, vShuffledVertPos] =...
            genWeightedBlockmodelWithBackground(sPosDist, posNum, graphSize, bShuffle, vBackgroundProp, sBlockmodelType,...
                vMeanDense, vStdDense, ccDenseBlockParams, meanSparse, stdSparse, cSparseBlockParams);
