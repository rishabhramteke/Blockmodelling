classdef EucTriFactAdjDeg < EucTriFactAdj
    % 
    % Euclidean tri-factorisation adjusted
    ...
    methods
        function obj = EucTriFactAdjDeg(mWeight, varargin)
            %
            % constructor
            % mWeight - weight adjustment matrix.
            %
            
            obj@EucTriFactAdj(mWeight, varargin{:});
