...
%             ftObj = @(t) fObjective.coordDescDistance(mAdj, mImage, mMembership, t, r, c); 
            ftObj = @(t) computeObjectiveFuncOfStepSize(X0dis, X0X1dis, X1dis, t, r, c, mAdj, mImage, fObjective); 
...
function [dis] = computeObjectiveFuncOfStepSize(X0dis, X0X1dis, X1dis, stepSize, basisRow, basisCol, mAdj, mImage, fObjective)
            %
...
function [ X0dis, X0X1dis, X1dis, X2dis] = computeTraces(vX0, vX1)
            %   
