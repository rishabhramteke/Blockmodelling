function plotEvolvingBlockmodelsMod(cmSnapshots, cPartitions, aPartInfo, subplotsPerRow, vPartNum)
%
...
for currSubseq = 1 : size(aPartInfo,1)
    ...
    bPartIn = find(vPartNum == currSubseq);
    ...
    for t = 1 : endTime - startTime + 1
        ...
        if ~isempty(bPartIn),
            subplot(totalRow, totalCol, drawCol);
